    ...
    declare namespace Db {
        ...
        namespace Product {
            ...
            namespace Categories {
                ...
                export const IsPrimaryCategory: string;
                export const IsSecondaryCategory: string;
            }

            namespace ProductItems {
                export const Barcode: string;
                export const BrandBCode: string;
                export const BrandBrandName: string;
                export const BrandId: string;
                export const Categorys: string;
                export const Cost: string;
                export const ItemDesc: string;
                export const MainCategoryCategoryCategoryName: string;
                export const MainCategoryCategoryId: string;
                export const MainCategoryCategoryIsPrimaryCategory: string;
                export const MainCategoryCategoryIsSecondaryCategory: string;
                export const Mrp: string;
                export const ProductCategoryCategoryCategoryName: string;
                export const ProductCategoryCategoryId: string;
                export const ProductCategoryCategoryIsPrimaryCategory: string;
                export const ProductCategoryCategoryIsSecondaryCategory: string;
                export const ProductItemId: string;
                export const ProductName: string;
                export const ProductTypeCategoryCategoryName: string;
                export const ProductTypeCategoryId: string;
                export const ProductTypeCategoryIsPrimaryCategory: string;
                export const ProductTypeCategoryIsSecondaryCategory: string;
            ...
            namespace Stocks {
                ...
                export const PurchaseQty: string;
                export const Quantity: string;
                export const SaleQty: string;
                export const StockId: string;
                export const Units: string;
            }

            namespace Suppliers {
                export const SuppilerName: string;
