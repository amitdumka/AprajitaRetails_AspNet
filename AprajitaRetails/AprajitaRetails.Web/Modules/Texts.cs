    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText FormTitle = "Welcome to Aprajita Retails (The Arvind Store, Dumka)";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Aprajita Retails Account";
                    ...
                    public static LocalText FormTitle = "Sign up for Aprajita Retails";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Aprajita Retails";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText ContentDescription = "The Arvind Store, Dumka";
            }
            ...
            {
                public static LocalText FooterCopyright = "Copyright (c) 2015-"+DateTime.Today.Year+".";
                public static LocalText FooterInfo = "The Arvind Store, Dumka";
                public static LocalText FooterRights = "All rights reserved(Aprajita Retails).";
